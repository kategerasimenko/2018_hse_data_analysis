...
```{r}
colors <- read_csv('https://github.com/kategerasimenko/2018_hse_data_analysis/raw/master/hw5_CA_MCA/hw5_colreg.csv')
rownames(colors) <- c(1:11)
```
